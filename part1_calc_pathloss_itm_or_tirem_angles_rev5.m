function part1_calc_pathloss_itm_or_tirem_angles_rev5(app,rev_folder,folder_names,parallel_flag,sim_number,reliability,confidence,FreqMHz,Tpol,workers,string_prop_model,num_chunks)
                    ...
                    if var_exist1==0 || var_exist2==0
                        if parallel_flag==1
                            ...
                            parfor sub_point_idx=1:num_chunks  %%%%%%%%%Parfor
                                parfor_parchunk_PropModel_angels_rev4(app,cell_sim_chuck_idx,sub_point_idx,sim_array_list_bs,base_protection_pts,sim_number,data_label1,reliability,confidence,FreqMHz,Tpol,parallel_flag,point_idx,string_prop_model);
