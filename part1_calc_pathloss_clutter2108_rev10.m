function part1_calc_pathloss_clutter2108_rev10(app,rev_folder,folder_names,parallel_flag,sim_number,reliability,confidence,FreqMHz,Tpol,workers,string_prop_model,tf_recalc_pathloss,tf_server_status,tf_clutter)
        ...
        if cell_status{temp_cell_idx,2}==0
            ...
            if var_exist==2
                ...
                if strcmp(string_prop_model,'ITM')
                    dyn_chunks=ceil(num_bs/10000);
                    num_chunks=max([24,dyn_chunks]);
                    %%%%%ITM runs a bit faster, so we need less chunks.
                end
