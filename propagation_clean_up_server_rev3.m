function propagation_clean_up_server_rev3(app,rev_folder,folder_names,parallel_flag,sim_number,workers,string_prop_model,num_chunks,tf_server_status,tf_reclean)
