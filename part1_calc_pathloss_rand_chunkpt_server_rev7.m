function part1_calc_pathloss_rand_chunkpt_server_rev7(app,rev_folder,folder_names,parallel_flag,sim_number,reliability,confidence,FreqMHz,Tpol,workers,string_prop_model,num_chunks,tf_recalc_pathloss,tf_server_status)
                    ...
                    if var_exist1==0 || var_exist2==0
                        if parallel_flag==1
                            parfor chunk_idx=1:num_chunks  %%%%%%%%%Parfor
                                %%%%'Need to put the parfor_parchunk function here'
                                %%%%%The question is whether TIREM and ITM can do this parfor???
...
server_status_rev2(app,tf_server_status)
 ...
 %%%propagation_clean_up_server_rev2(app,rev_folder,folder_names,parallel_flag,sim_number,workers,string_prop_model,num_chunks,tf_server_status)
    %propagation_clean_up_server_rev3(app,rev_folder,folder_names,parallel_flag,sim_number,workers,string_prop_model,num_chunks,tf_server_status,tf_recalc_pathloss)
