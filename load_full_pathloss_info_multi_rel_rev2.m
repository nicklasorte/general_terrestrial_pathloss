function [array_full_pl_data,full_prop_mode_data,full_rx_angle_data]=load_full_pathloss_info_multi_rel_rev2(app,data_label1,string_prop_model,grid_spacing,tf_recalculate,base_protection_pts,sim_array_list_bs,sim_number,tf_tropo_cut,reliability)
