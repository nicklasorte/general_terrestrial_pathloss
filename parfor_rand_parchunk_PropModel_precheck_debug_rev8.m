function [pathloss,prop_mode,tf_stop_subchunk]=parfor_rand_parchunk_PropModel_precheck_debug_rev8(app,cell_sim_chuck_idx,sim_array_list_bs,base_protection_pts,sim_number,data_label1,reliability,confidence,FreqMHz,Tpol,parallel_flag,point_idx,string_prop_model,array_rand_chunk_idx,chunk_idx,file_name_pathloss,file_name_prop_mode)

sub_point_idx=array_rand_chunk_idx(chunk_idx);

if parallel_flag==0
    disp_TextArea_PastText(app,strcat('parfor_rand_parchunk_PropModel_precheck_debug_rev8: Line 6: sub_point_idx:',num2str(sub_point_idx)))  %%%%%Last Update Here before Pause: Line 6-Line 19: Probably->persistent_var_exist_with_corruption
end
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%Parchunk ParWrapper
...
if parallel_flag==0
    disp_TextArea_PastText(app,strcat('parfor_rand_parchunk_PropModel_precheck_debug_rev8: Line 19: var_exist1_chunk:',num2str(var_exist1_chunk),'_',num2str(var_exist2_chunk)))
end
...
if parallel_flag==0
    disp_TextArea_PastText(app,strcat('parfor_rand_parchunk_PropModel_precheck_debug_rev8: Line 27: var_exist1:',num2str(var_exist1),'_',num2str(var_exist2),'_',num2str(var_exist1_chunk),'_',num2str(var_exist2_chunk)))
end

if var_exist1==2 && var_exist2==2
    %'It does exist and we  don't need to load the sub-chunk
    if parallel_flag==0
        disp_TextArea_PastText(app,strcat('parfor_rand_parchunk_PropModel_precheck_debug_rev8: Line 33: var_exist1:',num2str(var_exist1),'_',num2str(var_exist2),'_',num2str(var_exist1_chunk),'_',num2str(var_exist2_chunk)))
    end
    tf_stop_subchunk=1;
    prop_mode=NaN(1,1);
    pathloss=NaN(1,1);
    ...
    if parallel_flag==0
        disp_TextArea_PastText(app,strcat('parfor_rand_parchunk_PropModel_precheck_debug_rev8: Line 40: var_exist1:',num2str(var_exist1),'_',num2str(var_exist2),'_',num2str(var_exist1_chunk),'_',num2str(var_exist2_chunk)))
    end
    ...
    if var_exist1_chunk==2 && var_exist2_chunk==2 && parallel_flag==0 %%%%%%%%%%%%%We should only load in the non-parllel
        if parallel_flag==0
            disp_TextArea_PastText(app,strcat('parfor_rand_parchunk_PropModel_precheck_debug_rev8: Line 46: var_exist1:',num2str(var_exist1),'_',num2str(var_exist2),'_',num2str(var_exist1_chunk),'_',num2str(var_exist2_chunk)))
        end
        retry_load=1;
        while(retry_load==1)
            try
    ...
    elseif var_exist1_chunk==2 && var_exist2_chunk==2 && parallel_flag==1  %%%%%Parallel, just need a placeholder: No loading
        ...
        if parallel_flag==0
            disp_TextArea_PastText(app,strcat('parfor_rand_parchunk_PropModel_precheck_debug_rev8: Line 65: var_exist1:',num2str(var_exist1),'_',num2str(var_exist2),'_',num2str(var_exist1_chunk),'_',num2str(var_exist2_chunk)))
        end
        ...
        if parallel_flag==0
            disp_TextArea_PastText(app,strcat('parfor_rand_parchunk_PropModel_precheck_debug_rev8: Line 85: var_exist1:',num2str(var_exist1),'_',num2str(var_exist2),'_',num2str(var_exist1_chunk),'_',num2str(var_exist2_chunk)))
        end
        ...
        if parallel_flag==0
            disp_TextArea_PastText(app,strcat('parfor_rand_parchunk_PropModel_precheck_debug_rev8: Line 95: var_exist1:',num2str(var_exist1),'_',num2str(var_exist2),'_',num2str(var_exist1_chunk),'_',num2str(var_exist2_chunk),'_',num2str(var_exist3),'_',num2str(var_exist4)))
        end
        ...
        if parallel_flag==0
            disp_TextArea_PastText(app,strcat('parfor_rand_parchunk_PropModel_precheck_debug_rev8: Line 111: var_exist1:',num2str(var_exist1),'_',num2str(var_exist2),'_',num2str(var_exist1_chunk),'_',num2str(var_exist2_chunk),'_',num2str(var_exist3),'_',num2str(var_exist4)))
        end
    end
    if parallel_flag==0
        disp_TextArea_PastText(app,strcat('parfor_rand_parchunk_PropModel_precheck_debug_rev8: Line 115: var_exist1:',num2str(var_exist1),'_',num2str(var_exist2),'_',num2str(var_exist1_chunk),'_',num2str(var_exist2_chunk)))
    end
end
    %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% End of Wrapper